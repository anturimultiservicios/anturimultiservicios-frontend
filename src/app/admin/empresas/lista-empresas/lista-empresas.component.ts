...
@Component({
  ...
  template: `
    <div class="pagina-lista">
      ...
      <div class="tarjeta pagina-filtros">
        <input type="text" class="campo-input" placeholder="Buscar por nombre o NIT...">
      </div>
      <div class="tarjeta pagina-tabla-contenedor">
        <p style="padding: var(--espacio-8); text-align: center; color: var(--texto-terciario);">
          Conecte el backend para ver las empresas registradas.
        </p>
      </div>
    </div>
  `,
  styles: [`
    ...
    .pagina-tabla-contenedor { padding: var(--espacio-4); }
  `]
})
