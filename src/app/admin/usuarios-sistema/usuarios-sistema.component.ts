  ...
  template: `
    <div class="pagina-lista">
      ...
      <div class="tarjeta" style="padding: var(--espacio-8); text-align: center; color: var(--texto-terciario);">
        Aquí podrá crear y gestionar las cuentas de secretarias con sus permisos específicos.
        Conecte el backend para ver los usuarios registrados.
      </div>
    </div>
  `,
  styles: [`
...
export class UsuariosSistemaComponent {}
